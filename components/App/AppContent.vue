    ...
    <main>
      <div class="relative isolate">
        ...
        <div class="overflow-hidden">
          <div
            class="mx-auto max-w-7xl px-6 pb-22 pt-36 sm:pt-60 lg:px-8 lg:pt-32"
          >
            <div
            ...
            >
              <div class="w-full max-w-xl lg:shrink-0 xl:max-w-2xl">
                ...
                >
                  Our software development process is a systematic approach to
                  creating high-quality software. It is designed to ensure that
